...
def train(args):
    ...
    env = env_creator(args.num_good, args.num_adversaries, args.num_obstacles, args.max_cycles)
    ...
    result_dir = os.path.join("/home/rkamatar/train_trial/results", args.model)
